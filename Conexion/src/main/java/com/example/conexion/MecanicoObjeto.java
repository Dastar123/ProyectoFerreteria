...
public class MecanicoObjeto {
     ...
     */
    public MecanicoObjeto(String id, String rol, String horas, String seguro, String nombre, String numero,
    ...
    public static void crearImagenes(Button button,  AnchorPane fondo,boolean nochedia) {
        ...
        if ( Iniciador.nochedia) {
            Image lunaImage = new Image(MecanicoPanelControlador.class.getResourceAsStream("/imgs/luna.png"));
            ...
            Image solImage = new Image(MecanicoPanelControlador.class.getResourceAsStream("/imgs/sol.png"));
    ...
    public static void cambiarClaroOscuro( AnchorPane fondo,boolean nocheDia) {
        try {
            ...
            if (scene != null) {
                String cssOscuro = InsertMecanicoControlador.class.getResource("/styles/style_night.css").toExternalForm();
                String cssClaro = InsertMecanicoControlador.class.getResource("/styles/style_day.css").toExternalForm();
